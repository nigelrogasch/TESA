...
if nargin < 2
    ...
    uilist = {{'style', 'text', 'string', ''} ...
              ...
              {'style', 'text', 'string', ''} ...
              {'style', 'text', 'string', ''} ...
              {'style', 'text', 'string', 'Settings for auto-detecting artefact components','fontweight','bold'} ...
              {'style', 'text', 'string', ''} ...
              ...
              {'style', 'text', 'string', 'Threshold for detection'} ...
              {'style', 'edit', 'string', '4'} ...
              {'style', 'text', 'string', '  For further information on settings for artefact','fontAngle','italic'} ...
              {'style', 'text', 'string', 'Threshold feedback'} ...
              {'Style', 'checkbox', 'string' 'on/off' 'value' 0 'tag' 'pair' } ...
              {'style', 'text', 'string', '  component selection, see help or the user manual','fontAngle','italic'} ...
              {}...
              {'style', 'text', 'string', 'Press enter when you have categorised each IC. Blue plots are auto-categorised as neural, red plots as artefacts.','fontAngle','italic'}...
              };
          
    result = inputgui('geometry', geometry, 'uilist', uilist, 'title', 'Find artefact components -- pop_tesa_compselect()', 'helpcom', 'pophelp(''pop_tesa_compselect'')');
